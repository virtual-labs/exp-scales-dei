...
pencil1Step3.addEventListener("click", (evt) => {
    ...
    setTimeout((evt) => {
        ...
        instruction1Step3.innerText = "Now make a rectangle.";
...
pencil2Step3.addEventListener("click", (evt) => {
    ...
    instruction1Step3.innerText = "Divide the rectangle into 4 equal parts.";
...
pencil3Step3.addEventListener("click", (evt) => {
    ...
    instruction1Step3.innerText = "Select 3H pencil and draw a line inclined to the rectangle.";
...
pencil4Step3.addEventListener("click", (evt) => {
    ...
    setTimeout(() => {
        ...
        instruction1Step3.innerText = "Select the Compass and devide the line into 10 equal parts.";
...
pencil5Step3.addEventListener("click", (evt) => {
    ...
    setTimeout(() => {
        ...
        instruction1Step3.innerText = "Select H pencil and subdivide the division to the left of zero into subunits.";
...
pencil6Step3.addEventListener("click", (evt) => {
    ...
    setTimeout(() => {
        ...
        instruction1Step3.innerText = "Select 3H pencil and take a length of line starting from zero equal to 9 m.s.d .";
...
pencil7Step3.addEventListener("click", (evt) => {
    ...
    instruction1Step3.innerText = "Select 3H pencil and make an inclined line.";
...
pencil8Step3.addEventListener("click", (evt) => {
    ...
    setTimeout(() => {
        ...
        instruction1Step3.innerText = "Select compass and divide the line into 10 equal parts.";
...
comp3Step3.addEventListener("click", (evt) => {
    ...
    setTimeout(() => {
        ...
        arr1Step3.style.visibility = "visible";
        instruction1Step3.innerText = "Now, Select 3H pencil and draw parallel lines.";
...
pencil9Step3.addEventListener("click", (evt) => {
    ...
    setTimeout(() => {
        ...
        instruction1Step3.innerText = "Select H pencil and subdivide the division into 10 equal parts.";
